...
def translate_subtitles(subtitle_id):
    ...
    subs = pysubs2.load(f'{settings.BASE_DIR}/static/images/{input_file.name}')
    ...
    output_file = f'{settings.BASE_DIR}/static/images/output_files_subtitle/{name_output_file}'
